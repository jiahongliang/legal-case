...
@Slf4j
@RestController
@RequestMapping(value = "/data-interface/provider/law-article-classification")
public class LawArticleClassificationDataProvider extends BaseDataProvider<LcLawArticleClassification> {
}
