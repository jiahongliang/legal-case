...
import { Layout, Menu, Row, Col, Dropdown, Breadcrumb, Divider, Tag, Drawer, Form, Input, Button, Result } from "antd";
...
const Console = () => {
    ...
    useEffect(() => {
        ...
        if(loginUserToken && loginUserToken.length > 0) {
            ...
            let newMenus = menus.filter(menu => roleArray.indexOf(menu.role) > -1).map(menu => ({...menu, children: menu.children ? menu.children.filter(mo => roleArray.indexOf(mo.role) > -1) : []}));
